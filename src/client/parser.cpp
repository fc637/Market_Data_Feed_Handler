...
// constexpr size_t MAX_BUFFER = 1 << 20; // 1MB safety buffer
...
//         // Prevent overflow (malicious sender)
//         if (write_pos_ + len > MAX_BUFFER) {
//             std::cerr << "[PARSER] Buffer overflow risk, resetting\n";
//             reset();
//             return;
...
//                 break;
//             case MSG_QUOTE:
//                 payload_size = 8 + 4 + 8 + 4;
//                 break;
//             case MSG_HEARTBEAT:
//                 payload_size = 0;
//                 break;
//             default:
//                 std::cerr << "[PARSER] Invalid message type\n";
//                 drop_bytes(1);
//                 continue;
//             }
...
//             uint32_t actual = xor_checksum(ptr, msg_size - 4);

//             if (expected != actual) {
//                 std::cerr << "[PARSER] Checksum failed\n";
//                 drop_bytes(1);
//                 continue;
//             }
...
//                 std::cerr << "[PARSER] SEQ GAP expected="
//                           << last_seq_ + 1
//                           << " got=" << seq << "\n";
//             }
//             last_seq_ = seq;
...
//             // In real system: forward to visualizer/cache
//             // on_tick(tick);
...
//         std::memmove(buffer_, buffer_ + read_pos_, write_pos_ - read_pos_);
//         write_pos_ -= read_pos_;
//         read_pos_ = 0;
//     }
// };
